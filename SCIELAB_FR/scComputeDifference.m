...
result1 = ClipXYZImage(xyz1, whitePt{1});
result2 = ClipXYZImage(xyz2, whitePt{2});

switch deltaEVer
    case {'2000','1994','1976'}
        result = deltaEab(result1, result2, whitePt, deltaEVer);        
    case {'luminance','chrominance','hue'}
        [result, components] = deltaEab(result1, result2, whitePt, deltaEVer);
    ...
    case {'all'}
        [result.dE, result.components] = deltaEab(result1, result2, whitePt, deltaEVer);
    otherwise

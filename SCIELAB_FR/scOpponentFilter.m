...
switch lower(params.imageFormat(1:3))
    case 'lms'
        opp = changeColorSpace(image, cmatrix('lms2opp'));
        % figure(1); imagescRGB(opp);
    case 'xyz'
        opp = changeColorSpace(image, cmatrix('xyz2opp', xyztype));
...
filteredXYZ = changeColorSpace(filteredOpp, cmatrix('opp2xyz', xyztype));

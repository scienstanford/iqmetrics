function [res] = VSNR_FR(src_img, dst_img, alpha, viewing_params)
%% Visual signal-to-noise ratio for digital images (VSNR)
% Chandler, D. M., Hemami, S. S. "VSNR: A Wavelet-Based Visual Signal-to-Noise 
% Ratio for Natural Images", IEEE Trans Image Processing, 16(9):2284 - 2298, 2007.
